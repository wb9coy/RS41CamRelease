...
HAL_StatusTypeDef setupRadio(SPI_HandleTypeDef *hspiParam)
{
	  ...
	  //The clock for the IC is provided from the osc of the
	  //GPS module, which is however only 26 MHz, it should be 30 MHz.
	  //This has to be taken into account when setting up radio frequencies.
	  //Data Rate 9.6kbps
